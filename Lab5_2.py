...
if __name__ == '__main__':
    ...
    dataset = [x[:delCol] + x[delCol + 1:] for x in dataset]
    data = data[:delCol] + data[delCol + 1:]
    ...
    classifier = RandomForestClassifier(n_estimators=numTrees, criterion=criterion, random_state=0)
