...
if __name__ == '__main__':
    ...
    dataset = [row[:del_col] + row[del_col+1:] for row in dataset]
    ...
    classifier = RandomForestClassifier( n_estimators=number_of_trees, criterion=type, random_state=0)
